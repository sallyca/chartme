...
class TitlesControllerTest < ActionController::TestCase
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post :create, title: { category: @title.category, company: @title.company, date: @title.date, is_active: @title.is_active, responses: @title.responses }
    end
  ...
  test "should update title" do
    put :update, id: @title, title: { category: @title.category, company: @title.company, date: @title.date, is_active: @title.is_active, responses: @title.responses }
    assert_redirected_to title_path(assigns(:title))
  end
